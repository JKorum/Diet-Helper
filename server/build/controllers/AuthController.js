...
var AuthController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!errors.isEmpty()) {
                            res.status(422).send({
                                error: 'required: name (min 2 chars), email (valid) and password (min 6 chars)'
                            });
                            return [2 /*return*/];
                        }
                        _a.label = 1;
    ...
    AuthController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, _a, email, password, user, match, err_2;
    ...
    __decorate([
        ...
        decorators_1.use(validators_1.registerValidator, null),
    ...
    __decorate([
        ...
        decorators_1.use(validators_1.loginValidator, null),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", Promise)
